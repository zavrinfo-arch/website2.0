...
import {
  ...
  Sparkles, Zap, Heart, Star, ArrowRight, ChevronDown,
...
const STATS = [
  ...
  { value: '4.9', label: 'Store Rating', suffix: '★' },
];

const TESTIMONIALS = [
  { name: 'Sarah M.', text: 'Zavr changed how I think about saving. The streak system keeps me motivated every single day!', role: 'Verified User' },
  { name: 'James K.', text: 'My partner and I saved for our wedding using group goals. It made it actually fun!', role: 'Premium User' },
  { name: 'Priya T.', text: 'The AI assistant helped me budget for my first car. Best financial app ever!', role: 'Pro User' },
];
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <motion.div
        ...
        className="absolute w-[520px] h-[520px] opacity-40"
        style={{
      ...
      <motion.div
        ...
        className="absolute w-[420px] h-[420px] opacity-30"
        style={{
  ...
  return (
    ...
    >
      <motion.div style={{ y, opacity }} className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          {/* Glow behind */}
          <div className="absolute inset-x-1/4 -top-10 h-40 blur-[80px] opacity-40 bg-gradient-to-r from-[#F43F5E] via-[#2DD4BF] to-[#F59E0B]" />
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              {[
                ...
                <motion.div
                  ...
                  className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]"
                >
                  <div
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={goal.name} className="flex items-center gap-4">
                  <span className="text-xs text-white/50 w-28 truncate">{goal.name}</span>
                  ...
                  <span className="text-xs text-white/40 w-10 text-right">{goal.progress}%</span>
                </div>
              ))}
            </div>
          </GlassCard>
  ...
  return (
    <section ref={ref} className="relative py-24 md:py-32 overflow-hidden">
      ...
      <motion.div
        aria-hidden
        style={{ y: bgGlowY }}
        className="absolute left-1/2 top-1/3 -translate-x-1/2 w-[700px] h-[500px] rounded-full opacity-40 pointer-events-none"
      >
        <div
              ...
              >
                <div className="relative">
                  <GlassCard className="relative p-2 rounded-[2.5rem] overflow-hidden">
                    ...
                    <div className="bg-[#09090B] rounded-[2.25rem] p-6 min-h-[480px] flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((item, i) => (
            <motion.div
              ...
              transition={{ delay: 0.1 + i * 0.1, duration: 0.5 }}
            >
              <GlassCard className="p-8 text-center h-full" glow="teal">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
            Trusted by
            <br />
            <span className="bg-gradient-to-r from-[#F43F5E] via-[#2DD4BF] to-[#F59E0B] bg-clip-text text-transparent">50,000+ Savers</span>
          </h2>
        </motion.div>
          ...
          {STATS.map((stat, i) => (
            ...
            >
              <GlassCard className="p-8 text-center">
                <p className="text-4xl md:text-5xl font-black bg-gradient-to-br from-[#F43F5E] to-[#2DD4BF] bg-clip-text text-transparent mb-2">
            ...
            >
              <GlassCard className="p-6 h-full">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#F43F5E] to-[#2DD4BF]" />
                  <div>
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          <GlassCard className="p-8 md:p-16 text-center relative overflow-visible">
            {/* Glow behind */}
            <div className="absolute inset-x-0 -top-20 h-40 blur-[100px] opacity-30 bg-gradient-to-r from-[#F43F5E] via-[#2DD4BF] to-[#F59E0B]" />
        ...
        >
          ...
          <div className="relative min-h-[180px] flex items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-2xl md:text-3xl font-bold text-white/90 leading-snug max-w-3xl mb-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['About', 'Blog', 'Careers', 'Contact'].map((item) => (
                <li key={item}>
                  <a href="#about" className="text-sm text-white/50 hover:text-white transition-colors">{item}</a>
                </li>
              ))}
            </ul>
          </div>
